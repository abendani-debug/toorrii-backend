...
class ConditionDutilisationAdminSerializer(serializers.ModelSerializer):
    class Meta:
        model = ConditionDutilisation
        fields = "__all__"  # Tous les champs
        read_only_fields = ["condition_id", "date_creation", "historiqueModifications"]
...
class ConditionDutilisationPublicSerializer(serializers.ModelSerializer):
    class Meta:
        model = ConditionDutilisation
        fields = [
            "titre",
